<div class="relative bottom-0 z-10">
    <footer class="bg-white dark:bg-slate-900">
        <div class="container flex flex-col items-center justify-between p-6 mx-auto space-y-4 sm:space-y-0 sm:flex-row">
            ...
            <div class="flex -mx-2">
                <a href="#" class="mx-2 text-slate-700 transition-colors duration-300 dark:text-slate-300 hover:text-sky-400 dark:hover:text-sky-500" aria-label="Reddit">
                ...
                <a href="#" class="mx-2 text-slate-700 transition-colors duration-300 dark:text-slate-300 hover:text-sky-400 dark:hover:text-sky-500" aria-label="Github">
