        ...
        <div class="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
            <div class="flex items-center justify-between">
                ...
                <div class="flex lg:hidden">
                    <button x-cloak @click="isOpen = !isOpen" type="button" class="text-slate-900 dark:text-slate-400 dark:hover:text-slate-300 hover:text-slate-700  focus:outline-none focus:text-slate-900 dark:focus:text-slate-700" aria-label="toggle menu">
